...
window.displaySave = function () {
	...
	var tempString = "";
	tempString = '<table style="width:100%; border-spacing:0; color:transparent;"><tr><td style="padding:8px; white-space:nowrap;">Slot:</td><td style="padding:8px; width:100%;"><select id="saveSelect" name="saveSelect" onchange="changeSaveButton()" class="setup-select">';
