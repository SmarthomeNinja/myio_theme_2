...
for (j=0;j<256;j++){
	if(slotExist[j] == 1){
		...
		document.write('<tr><td align="center"><button name="sav_gl" value="'+j+'" onclick="changed(this)" >'+str_Gen+'</button></td>');
		document.write('<td align="center"><button name="sav_sw" value="'+j+'" onclick="changed(this)" >'+str_Input+'</button></td>');
		document.write('<td align="center"><button name="sav_r" value="'+j+'" onclick="changed(this)" >'+str_Output+'</button></td></tr>');
		document.write('<tr><td align="center"><button name="sav_f" value="'+j+'" onclick="changed(this)" >'+str_PWM+'</button></td>');
		document.write('<td align="center"><button name="sav_gr" value="'+j+'" onclick="changed(this)" >'+str_Group+'</button></td>');
		document.write('<td align="center"><button name="sav_pr" value="'+j+'" onclick="changed(this)" >'+str_Prot+'</button></td></tr></table></td>');
		document.write('<td align="center"><button name="sav_all" value="'+j+'" onclick="changed(this)" >'+str_SaveAll+'</button></td>');
		document.write('<td align="center"><button name="del_slot" value="'+j+'" onclick="changed(this)" >'+str_Delete+'</button></td></tr>');
		}
}
document.write('<tr><th colspan="4">');
if(slotQuantity < slotExist.length){	
	document.write('<button name="new_slot" onclick="changed(this)" >' + str_NewSlot + '</button>');	
}
